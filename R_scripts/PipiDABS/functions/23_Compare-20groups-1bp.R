...
myCompare_20groups_1bp_g <- function(methylBase_temp_1,  myPath_temp_1,  qvalue_temp_1,  differenceOfMethylation_temp_1,      mergeDistance_temp_1=100,   numCores_temp_1=8 ) {                                             
...
if( (! is.null(group_1_g)) && (! is.null(group_2_g))   ) {
    ...
    myMainFunction1bp_1_g(myobj_temp2 = methylBase_temp_1,     
                       ...
                       dataFrame_temp2=dataFrame_temp1_A, numCores_temp2=numCores_temp_1 
                      ) 
}
