...
A0=1_BA9.txt.SNP-Phe-Pair.txt
A1=2_BA24.txt.SNP-Phe-Pair.txt
A2=3_C.txt.SNP-Phe-Pair.txt
A3=4_H.txt.SNP-Phe-Pair.txt
A4=5_T.txt.SNP-Phe-Pair.txt

outdir="SNPs-Gene_Pair-Overlap"
mkdir  $outdir 
