...
out="101-Matrix-1nt/minus-Strand"
mkdir  -p  $out

computeMatrix scale-regions    --scoreFileName  $input/HEK293.bw $input/Hela.bw $input/HepG2.bw     --regionsFileName  100-classified-regions/1nt/3UTR.bed     \
...
computeMatrix scale-regions    --scoreFileName  $input/HEK293.bw $input/Hela.bw $input/HepG2.bw     --regionsFileName  100-classified-regions/1nt/5UTR.bed     \
...
computeMatrix scale-regions    --scoreFileName  $input/HEK293.bw $input/Hela.bw $input/HepG2.bw     --regionsFileName  100-classified-regions/1nt/CDS.bed     \
...
out="101-Matrix-1nt/plus-Strand"
mkdir  -p  $out
