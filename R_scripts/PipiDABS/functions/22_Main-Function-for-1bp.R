...
#)
myMainFunction1bp_1_g  <- function(  myobj_temp2,   path_temp2,  qvalue_temp2, differenceOfMethylation_temp2, mergeDistance_temp2=100,  dataFrame_temp2, numCores_temp2=8  ) {               
